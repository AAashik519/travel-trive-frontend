...
<section className="bg-white dark:bg-gray-900">
  <h2 className='text-center text-2xl text-red-600 italic'>Testimonial</h2>
  <h2 className='text-center text-4xl text-blue-900 italic font-bold mt-2'>What Travelers Says</h2>
